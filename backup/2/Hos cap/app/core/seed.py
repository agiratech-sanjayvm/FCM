...
DEMO_USERS = [
    ...
    {"name": "Bobson Patient", "email": "bobson@example.com", "role": UserRole.USER},
    {"name": "Robson Patient", "email": "robson@example.com", "role": UserRole.USER},
    {"name": "Robin Patient", "email": "robin@example.com", "role": UserRole.USER},
    {"name": "Smithie Patient", "email": "smithie@example.com", "role": UserRole.USER},
    {"name": "Annie Patient", "email": "annie@example.com", "role": UserRole.USER},
